...
"hi Normal ctermfg=Black guifg=Black guibg=#98984b

hi SpecialKey term=bold ctermfg=DarkBlue guifg=Blue
hi NonText term=bold ctermfg=DarkBlue cterm=bold gui=bold guifg=#808080
hi Directory term=bold ctermfg=DarkBlue guifg=Blue
hi ErrorMsg term=standout ctermfg=Gray ctermbg=DarkRed cterm=bold gui=bold guifg=White guibg=DarkRed
hi IncSearch term=reverse cterm=reverse gui=reverse
hi Search term=reverse ctermbg=Black ctermfg=White cterm=reverse guibg=Yellow
hi MoreMsg term=bold ctermfg=DarkGreen gui=bold guifg=SeaGreen
hi ModeMsg term=bold cterm=bold gui=reverse
hi LineNr term=underline ctermfg=DarkCyan ctermbg=Gray guibg=#808080 gui=bold guifg=black
hi Question term=standout ctermfg=DarkGreen gui=bold guifg=SeaGreen
hi StatusLine term=bold,reverse cterm=bold,reverse gui=bold guifg=Gray guibg=Black
...
hi WarningMsg term=standout ctermfg=DarkRed gui=bold guifg=DarkRed
...
hi CursorLine guibg=#9b9b9b gui=none
...
hi Comment term=bold ctermfg=DarkBlue guifg=#2e5c5c
hi Constant term=underline ctermfg=DarkRed guifg=DarkMagenta
hi Special term=bold ctermfg=DarkMagenta gui=bold guifg=#8C0000
hi Identifier term=underline ctermfg=DarkCyan cterm=NONE guifg=#106060
hi Statement term=bold ctermfg=DarkRed cterm=bold gui=bold guifg=DarkBlue
hi PreProc term=underline ctermfg=DarkMagenta gui=bold guifg=#006400
hi Type term=underline ctermfg=DarkGreen gui=bold guifg=DarkBlue
