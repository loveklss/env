...
hi ModeMsg guibg=DarkGreen guifg=Gray gui=bold
hi Title guibg=bg guifg=#c2b680 gui=bold
hi PreProc guibg=bg guifg=#008000 gui=bold
hi Statement guibg=bg guifg=#c464c8 gui=bold
hi! link Todo ModeMsg
"hi! link Type Statement
"hi String guifg=DarkRed gui=none 
"hi Number guibg=bg guifg=LightRed gui=none
